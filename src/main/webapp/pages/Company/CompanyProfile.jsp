                    ...
                    <section class="featured-job-area">
                        <div class="container">
                            <div class="bg-gray-100 rounded p-5">
                                <form action="<%=request.getContextPath()%>/company/profile/update" method="post">
                                    <div class="flex gap-5">
                                        <div class="w-auto">
                                            ...
                                            <input name="cname" id="cname" type="text" placeholder="Company Name"
                                                   required
                                                   pattern=".{3,45}" title="3-45 letters" value="<%=c.getName()%>"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input name="email" id="email" type="email" placeholder="Email" required
                                               pattern=".{,45}" title="Max 45 letters" value="<%=c.getEmail()%>"
                                               class="w-full p-2 rounded-lg border-2 border-gray-200 outline-none focus:border-cyan-400">
                                    ...
                                    <div class="flex flex-row gap-5">
                                        ...
                                        <input
                                                class=" text-cyan-400 hover:bg-cyan-400 hover:text-white border border-cyan-400 font-bold py-2 px-4 rounded mt-5"
                                                type="submit" value="Exit">
                                    </div>
                                </form>
                                <div class="mt-3">
                                    <div class="my-3 w-96 mx-1">
                                        <form action="<%=request.getContextPath()%>/UploadDownload/CompanyUploadProfile"
                                              method="post"
