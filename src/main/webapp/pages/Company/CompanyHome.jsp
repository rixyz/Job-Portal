...
<%
    ...
    int EmpCount = CompanyService.getCompanyEmployees(id).size();
    int applicantCount = JobService.getAppliedCount((String) session.getAttribute("ID"));
    int jobCount = JobService.getJobList(id).size();
%>
<!DOCTYPE html>
<html>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <section class="featured-job-area">
                        <div class="container">
                            <div
                                    class="bg-gray-100 rounded grid grid-cols-4 grid-flow-row gap-4 p-2 place-content-center">
                                <div class="bg-yellow-100 rounded-md m-1 p-1 grid place-items-center text-lg">
                                            <span>
                                                Your Credit
                                            </span>
                                    <%=CompanyService.getCompanyById((String) session.getAttribute("ID")).getCredit()%>
                                ...
                                <div class="bg-white rounded-md m-1 grid place-items-center text-lg py-2">
                                            <span>
                                                Applications Recommended
                                            </span>
                                    4
                                </div>
                                <div class="bg-white rounded-md m-1 p-1 grid place-items-center text-lg col-span-4 row-span-2">
...
<!-- JS here -->
<script>
    let xValues = ["Employee", "Recommender", "Applicants", "Total Jobs"];
    let yValues = [<%=EmpCount%>, 4, <%=applicantCount%>, <%=jobCount%>];
    let barColors = [
        "rgb(134, 239, 172)",
        "rgb(110, 231, 183)",
        "rgb(94, 234, 212)",
