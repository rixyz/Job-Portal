            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <section class="featured-job-area">
                        <div class="container">
                            <form action="<%=request.getContextPath()%>/company/employee/add" class="search-box"
                                  method="post">
                                <div class="input-form">
                                    <input type="email" placeholder="Employee email" tabindex="0" name="email">
                                </div>
                                <div class="search-form">
                                    <input type="submit" value="Add Employee" tabindex="0">
                                </div>
                            </form>
                            <%
                                List<Employee> A = (List<Employee>) request.getAttribute("EmployeeList");
                            ...
                            <div class="single-job-items mb-30">
                                <div class="job-items">
                                    ...
                                    <div class="job-tittle job-tittle2">
                                        <a href="UploadDownload/DownloadResume&id=<%=e.getID()%>"
                                           target="_blank">
                                            <h4><%=e.getFullname()%>
                                            </h4>
                                        </a>
                                ...
                                <div class="items-link items-link2 f-right">
                                    <form action="<%=request.getContextPath()%>/company/employee/remove/<%=e.getID()%>"
                                          method="post">
                                        <input value="Remove" type="submit"
                                               class="trans-effect border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white py-2 px-4 align-content-center rounded-full">
                                    </form>
                                </div>
                            </div>
                            <% }
                            ...
                            %>
                            <div class="flex justify-center text-2xl strong m-5">No Active Employee</div>
                            <%
                                }
                            %>
