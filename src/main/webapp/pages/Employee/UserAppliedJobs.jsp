                            ...
                            <%
                                ...
                                if (!A.isEmpty()) {
                                    for (JobApplication a : A) {
                                        ...
                                        Company c = CompanyService.getCompanyById(j.getComID());
                            %>
                            <div class="single-job-items single-job-items-override  mb-30">
                                <!-- single-job-content -->
                                <div>
                                    <div class="flex flex-row justify-content-between mb-10">
                                        <div class="job-items">
                                        ...
                                        <% if (a.getApproved().equalsIgnoreCase("WAIT")) {%>
                                        <div class="items-link items-link2 f-right">
                                            <form action="<%=request.getContextPath()%>/employee/jobs/unapply/<%=j.getID()%>"
                                                  method="post">
                                    ...
                                    <div class="bg-white flex position-relative pt-10">
                                        <ol class="steps">
                                    ...
                                    <%} else if (a.getApproved().equalsIgnoreCase("YES")) {%>
                                    <div class="items-link items-link2 f-right">
                                        <form action="<%=request.getContextPath()%>/employee/jobs/info/<%=j.getID()%>"
                                              method="get">
                                            <button class="bg-green-500 border-white text-white bg-red-500 border-white text-white py-2 px-4 rounded-full">
                                                Accepted
                                            </button>
                                        </form>
                                    </div>
                                </div>
                                <div class="bg-white flex position-relative p-10">
                                    <ol class="steps">
                                        <li class="step is-complete" data-step="1">
                                            Apply to job
                                        </li>
                                        ...
                                        <li class="step is-active" data-step="3">
                                            <span class="d-block"> Pass Interview</span>
                                ...
                                <div class="items-link items-link2 f-right">
                                    <button disabled
                                            class="border-2 border-red-600 text-red-600 py-2 px-4 rounded-full">
