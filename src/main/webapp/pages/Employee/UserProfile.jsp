                            ...
                            <div class="select-Categories pb-50">
                                <div class="small-section-tittle2 ">
                                    <h4 class="p-2 pl-3 pb-1 rounded">
                                        <a href="<%=request.getContextPath()%>/home" class="hover:text-cyan-400">
                                ...
                                <div class="small-section-tittle2">
                                    <h4 class="p-2 pl-3 pb-1 rounded bg-cyan-400  text-white">
                    ...
                    <section class="featured-job-area">
                        <div class="container">
                            <div class="bg-gray-100 rounded p-5">
                                <form action="<%=request.getContextPath()%>/employee/profile/update"
                                      method="post">

                                    <div class="flex gap-5">
                                        <div class="flex flex-col mb-2 w-half">
                                            <label class="block text-grey-darker text-sm font-bold text-slate-800 mb-1"
                                                   for="firstName">
                                                First Name
                                            </label>
                                        ...
                                        <img class="h-20 w-20 rounded-full ml-auto object-cover"
                                             src="<%=request.getContextPath()%>/files/user/<%=session.getAttribute("ID")%>/profile.png"
                                             onerror=this.src="<%=request.getContextPath()%>/assets/img/user/null/profilepic.jpeg"
                                             alt=""
                                        >
                                    </div>
                                    <div class="mb-2">
                                        <label class="block text-grey-darker text-sm font-bold mb-1 text-slate-800 "
                                               for="email">
                                            Email
                                        </label>
                                        <input name="email" value="<%=e.getUemail()%>"
                                               class="w-full p-2 rounded-lg border-2 border-gray-200 outline-none mb-2 focus:border-cyan-400"
                                        ...
                                        <input name="password"
                                               class="w-full p-2 rounded-lg border-2 border-gray-200 outline-none mb-2 focus:border-cyan-400"
                                               id="password" type="password" placeholder="********" pattern=".{8,}"
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <textarea
                                                    ...
                                                    required
                                                    maxlength="1000"
                                                    title="3-1000 letters"><%=e.getAbout()%></textarea>
                                        </div>
                                    </div>
                                    <div class="flex flex-row gap-5">
                                        <input
                                                class="trans-effect bg-cyan-400 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded mt-1"
                                                type="submit" value="Update">
                                        <input
                                                class="trans-effect text-cyan-400 hover:bg-cyan-300 hover:text-white border border-cyan-400 font-bold py-2 px-4 rounded mt-1"
                                                type="submit" value="Exit">
                                    </div>
                                </form>
                                <div class="flex justify-content-between">
                                    <div class="my-3 w-96 mx-1">
                                        <form action="<%=request.getContextPath()%>/UploadDownload/EmployeeUploadProfile"
                                              method="post"
                                            ...
                                            <input type="file" id="ProfileFile" name="filename" required
                                                   accept="image/png, image/jpeg"
                                                   class="form-control block w-full px-2 py-1 mb-2 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"/>
                                            <input
                                                    class="trans-effect bg-cyan-400 hover:bg-cyan-600 text-white mb-2 font-bold py-2 px-4 rounded mt-1"
                                                    type="submit" value="Upload ">
                                        </form>
                                    </div>
                                    <div class="my-3 w-96">
                                        <form action="<%=request.getContextPath()%>/UploadDownload/UploadResume"
                                              method="post"
                                              enctype="multipart/form-data">
                                            ...
                                            <input type="file" id="ResumeFile" name="filename" required
                                                   accept="application/pdf"
                                                   class="form-control block w-full mb-2 px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"/>
                                            <input type="submit" value="Upload"
                                                   class="trans-effect bg-cyan-400 hover:bg-cyan-600 text-white font-bold mb-2 py-2 px-4 rounded mt-1">
                                            <a href="<%=request.getContextPath()%>/UploadDownload/DownloadResume/<%=e.getID()%>"
                                               target="_blank"
                                               class="text-cyan-400 hover:bg-cyan-300 hover:text-white border border-cyan-400 font-bold py-2 px-4 rounded mt-1">Download
                                            </a>
                                        </form>
                                    </div>
                                </div>
