                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="post-details3  mb-50">
                        ...
                        <div class="apply-btn2">
                            <form action="<%=request.getContextPath()%>/employee/jobs/apply/<%=j.getID()%>"
                                  method="post">
                            ...
                            %>
                            <form action="<%=request.getContextPath()%>/employee/jobs/recommend" method="post"
                                  class="mt-1">
                                <input type="text" name="email" placeholder="Email">
                                <input type="number" name="jid" hidden value="<%=j.getID()%>">
                                <button class="text-slate-800 hover:text-cyan-400 px-3 py-2 rounded-md text-sm font-medium">
                                    Recommend
                                </button>
                            </form>
                            <% }
                    ...
                    <div class="post-details4  mb-50">
                        ...
                        <ul>
                            ...
                            <li><a href="<%=request.getContextPath()%>/employee/company/info/<%=c.getID()%>"
                                   class="hoverblock">Ratings:
                                <span>
