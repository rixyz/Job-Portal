...
<%@ page import="JobPortal.Model.ReportData" %>
                    ...
                    <section class="featured-job-area">
                        <div class="container">
                            <div class="bg-gray-100 rounded grid grid-cols-3 grid-flow-row gap-4 p-2 place-content-center">
                                <div class="bg-white rounded-md m-1 p-1 grid place-items-center text-lg col-span-3 p-5 md:p-0">
                                    <canvas id="userChart" class="w-100"></canvas>
                                    <span>Member Stats</span>
                                </div>
                                <div class="bg-white rounded-md m-1 p-1 grid place-items-center text-lg col-span-3 p-5 md:p-0">
                                    <canvas id="jobChart" class="w-100"></canvas>
                                    <span>Job Stats</span>
                                </div>
...
<!-- JS here -->
<script>
    const months = <%=Arrays.toString(rd.getMonths())%>;
    new Chart("userChart", {
        type: "line",
        data: {
            labels: months,
            datasets: [
                {
                    label: 'Employee',
                    data: <%=Arrays.toString(rd.getEmployeeCount())%>,
                    borderColor: '#36a2eb',
                ...
                {
                    label: 'Company',
                    data:  <%=Arrays.toString(rd.getCompanyCount())%>,
                    borderColor: '#ff6384',
    ...
    new Chart("jobChart", {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Jobs',
                    data: <%=Arrays.toString(rd.getJobCount())%>,
                    borderColor: '#4bc0c0',
                ...
                {
                    label: 'Application',
                    data:  <%=Arrays.toString(rd.getApplicationCount())%>,
                    borderColor: '#ff9f40',
                    backgroundColor: '#ff9f4080',
                    fill: false,
                },
                {
                    label: 'Accepted Application',
                    data:  <%=Arrays.toString(rd.getSuccessCount())%>,
                    borderColor: '#9966ff',
                    backgroundColor: '#9966ff80',
                    fill: false,
                }
            ]
        },
