...
<%@ page import="JobPortal.Model.Sessions" %>
...
<%
    ...
    int CompCount = CompanyService.getCompanyCount();
    List<Sessions> S = (List<Sessions>) request.getAttribute("Sessions");
%>
<!DOCTYPE html>
<html>
            ...
            <div class="row">
                            ...
                            <div class="select-Categories pb-50">
                                ...
                                <div class="small-section-tittle2">
                                    <h4 class="p-2 pl-3 pb-1 rounded">
                                        <a href="<%=request.getContextPath()%>/admin/company"
                                ...
                                <div class="small-section-tittle2">
                                    <h4 class="p-2 pl-3 pb-1 rounded">
                                        <a href="<%=request.getContextPath()%>/admin/employee"
                                           class="hover:text-amber-400">
                                ...
                                <div class="small-section-tittle2">
                                    <h4 class="p-2 pl-3 pb-1 rounded">
                                        <a href="<%=request.getContextPath()%>/admin/jobs" class="hover:text-amber-400">
                                ...
                                <div class="small-section-tittle2">
                                    <h4 class="p-2 pl-3 pb-1 rounded">
                                        <a href="<%=request.getContextPath()%>/admin/data" class="hover:text-amber-400">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <section class="featured-job-area">
                        <div class="container">
                            <div class="bg-gray-100 rounded grid grid-cols-3 grid-flow-row gap-4 p-2 place-content-center">
                                <div class="bg-white rounded-md m-1 p-1 grid place-items-center text-lg col-span-3">
                                    <canvas id="twoChart" class="w-75"></canvas>
                                    <span>Portal Stats</span>
                                </div>
                                <div class="rounded-md m-1 grid place-items-center text-lg col-span-3">
                                    <%
                                        if (!S.isEmpty()) {
                                    %>
                                    <script src="<%=request.getContextPath()%>/assets/js/sorttable.js"></script>
                                    <span>Active Sessions</span>
                                    <table class="m-3 w-full text-sm text-left text-gray-700 dark:text-gray-400 border-2 sortable">
                                        <thead
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <%
                                                if (s.getType().equalsIgnoreCase("Company")) {
                                                    Company c = CompanyService.getCompanyById(s.getId());
                                            %>
                                            <td class="px-6 py-4">
                                                <%=c.getUserName()%>
                                            </td>
                                            ...
                                            <%
                                                ...
                                                Employee c = EmployeeService.getEmployeeById(s.getId());
                                            %>
                                            <td class="px-6 py-4">
                                                <%=c.getUserName()%>
                                            </td>
...
<!-- JS here -->
<script>
    var xValues = ["Seekers", "Companies"];
    var yValues = [<%=EmpCount%>, <%=CompCount%>];
    var barColors = [
        "rgb(134, 239, 172)",
        "rgb(110, 231, 183)"
    ];
