                            ...
                            <div class="select-Categories pb-50">
                                <div class="small-section-tittle2 ">
                                    <h4 class="p-2 pb-1 pl-3 rounded ">
                                        <a href="<%=request.getContextPath()%>/home" class="hover:text-amber-400">
                    ...
                    <div class="leftmar m-1 flex flex-wrap center">
                        ...
                        <table class="m-3 w-full text-sm text-left text-gray-700 dark:text-gray-400 border-2 sortable">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 sorttable_nosort">
                            ...
                            <tr class="bg-white dark:bg-gray-800">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <form method="post" class="d-inline"
                                          action="<%=request.getContextPath()%>/admin/company/creditadd/<%=c.getID()%>">
                                        <a onclick="this.parentNode.submit();"> (Add)</a>
                                    </form>
                                </td>
                                <td class="px-6 py-4 text-right d-flex d-flex justify-content-between">
                                    <form method="post"
                                          action="<%=request.getContextPath()%>/admin/company/edit/<%=c.getID()%>">
                                        <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline px-2"
                                           onclick="this.parentNode.submit();">
                                            Edit</a>
                                    </form>
                                    <form method="post"
                                          action="<%=request.getContextPath()%>/admin/company/delete/<%=c.getID()%>">
                                        <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline px-2"
                                           onclick="this.parentNode.submit();">
                                            Delete</a>
                                    </form>
