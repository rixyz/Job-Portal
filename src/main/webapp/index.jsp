            ...
            <div class="ml-3 relative">
                <div class="flex space-x-4 ">
                    <div class="p-3 border border-cyan-400 hover:bg-slate-200 ">
                        <a href="<%=request.getContextPath()%>/employee/auth"
                           class="text-slate-800 hover:text-cyan-400 px-3 py-2 rounded-md text-sm font-medium">
                            User Portal</a>
                    </div>
                    <div class="p-3 ">
                        <a href="<%=request.getContextPath()%>/company/auth"
                           class="text-slate-800 hover:text-cyan-400 px-3 py-2 rounded-md text-sm font-medium">
                            Company Portal</a>
                    </div>
                </div>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/js/particles.js"></script>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-tittle white-text text-center">
                    <span class="text-5xl text-cyan-400">Rojgar Life</span>
                    <h2 class="text-cyan-400"> How it works</h2>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="support-location-img">
                    <img src="<%=request.getContextPath()%>/assets/img/page-images/support-img.jpg" alt="">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="<%=request.getContextPath()%>/assets/img/page-images/home-blog1.jpg" alt="">
                            <!-- Blog date -->
                        ...
                        <div class="blog-cap">
                            <p>| Properties</p>
                            <h3>Footprints in Time is perfect House in Kurashiki
                            </h3>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="<%=request.getContextPath()%>/assets/img/page-images/home-blog2.jpg" alt="">
                            <!-- Blog date -->
                            <div class="blog-date text-center">
                                <span>24</span>
                                <p>Now</p>
