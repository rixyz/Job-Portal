...
<html>
    ...
    <body>
            ...
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div class="relative flex items-center justify-between h-24">
                    ...
                    <div class="ml-3 relative">
                        <div class="flex space-x-4 ">
                            <div class="p-3 border border-cyan-400 hover:bg-slate-200 ">
        ...
        <div class="h-max grid place-items-center bg-gray-50">
                    ...
                    <div class="tabs-content">
                        <div class="tab-content">
                            <div class="px-8 pb-8 flex flex-col mx-10 mb-10">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="email" name="email" id="lemail" placeholder="Email" required
                                                   class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-cyan-400">
                                        </div>
                                    </div>
                                    <div class="mb-6">
                                ...
                                <p class="mt-2"> <a href="ForgotPassword.jsp" class="hover:text-cyan-400">Forgot
                                        Password?</a>.
                                </p>
                            ...
                            <div class="px-8 pb-8 flex flex-col mx-10 mb-10">
                                ...
                                <form action="UserRegister" method="post">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input name="phone"
                                               class="w-full p-2 rounded-lg border-2 border-gray-200 outline-none focus:border-cyan-400"
                                               id="phone" type="tel" placeholder="XXX-XXX-XXXX" required pattern="^[0-9]{7,10}"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input name="userName"
                                               class="w-full p-2 rounded-lg border-2 border-gray-200 outline-none focus:border-cyan-400"
                                               id="userName" type="text" placeholder="Username" required pattern=".{3,45}"
                                               title="3-45 letters">
                                    </div>
                                    <div class="mb-6">
                                        <label class="block text-grey-darker text-sm font-bold mb-2" for="password">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div>
                                            <label for="gender" class="text-grey-darker text-sm font-bold mb-2">Gender:
                                            </label>
                                    ...
                                    <div class="mb-6">
                                        <label for="exp_in_years"
                                               class="text-grey-darker text-sm font-bold mb-2">Experience:
                                        </label>
                                    ...
                                    <div class="mb-6">
                                        <label class="block text-grey-darker text-sm font-bold mb-2">Preferred
                                            Industry</label>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <input class="bg-cyan-400 hover:bg-cyan-500 text-white font-bold py-2 px-4 rounded"
