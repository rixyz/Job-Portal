                                ...
                                <div class="container">
                                    ...
                                    <div class="single-job-items mb-30">
                                        ...
                                        <div class="items-link items-link2 f-right">
                                            <form action="Unapply" method="post">
                                                <input type="number" name="id" hidden value="<%=j.getJid()%>">
                                                <button class="bg-red-500 border-white text-white py-2 px-4 rounded-full">
                                                    <i class="fas fa-times"></i> Unapply
                                                </button>
                                            </form>
                                        </div>
                                        <%} else if (a.getApproved().equals("NO")) {%>
                                        <div class="items-link items-link2 f-right">
                                            <a href="job_details.html"
                                               class="bg-green-500 border-white text-white hover:bg-red-500">Accepted</a>
                                        </div>
                                        <%} else if (a.getApproved().equals("YES")) {%>
                                        <div class="items-link items-link2 f-right">
                                            <a href="job_details.html"
                                               class="bg-green-500 border-white text-white hover:bg-red-500">Accepted</a>
                                        </div>
