                                        ...
                                        <div class="single-job-items mb-30">
                                            <div class="job-items">
                                                ...
                                                <div class="job-tittle job-tittle2">
                                                    ...
                                                    <ul>
                                                        <li><%=c.getCname()%></li>
                                                        <li><i class="fas fa-map-marker-alt"></i><%=j.getLocation()%></li>
                                                        <li>Rs <%=j.getSalary()%></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="items-link items-link2 f-right">
                                                <button class="hover:bg-cyan-400 hover:text-white transition border-2 border-cyan-400 text-cyan-400 py-2 px-4 rounded-full">
                                                    Apply 
                                                </button>
                                            </div>
                                        </div>
