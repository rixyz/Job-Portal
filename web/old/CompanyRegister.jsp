        ...
        <div class="bg-opacity-25 bg-white h-min">
            <div class="border-2 rounded-md px-8 pt-6 pb-8 flex flex-col m-10">
                ...
                <form action="CompanyRegister" method="post">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="cname">
                        Company Name
                    </label>
                    <input name="cname"
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker mb-2"
                           id="cname" type="text" placeholder="Company Name" required pattern=".{3,45}" title="3-45 letters" >
                    <div class="mb-6">
                        <label class="block text-grey-darker text-sm font-bold mb-2" for="email">
                            Email 
                        </label>
                        <input name="email" id="email" type="email" placeholder="Email" required pattern=".{,45}" title="Max 45 letters"
                               class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker mb-2" >
                        ...
                        <input name="username"
                               class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker mb-2"
                               id="username" type="text" placeholder="Username" required pattern=".{3,16}" title="3-16 letters">
                        ...
                        <input name="password"
                               ...
                               id="password" type="password" placeholder="********" pattern=".{8,32}"
                               title="8-32 letters" required>
    ...
    <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        ...
        <div>
            ...
            <ul>
                ...
                <li class="mb-4">
                    <a href="#" target="_blank" rel="noreferrer"
                       class="text-gray-300 hover:underline">Twitter</a>
                </li>
                <li class="mb-4">
                ...
                <li class="mb-4"><a href="#" target="_blank" rel="noreferrer"
                                    class="text-gray-300 hover:underline">
                    </a><a href="#" target="_blank" rel="noreferrer"
                           class="text-gray-300 hover:underline">Contact
                        Us</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul>
                ...
                <li class="mb-4">
                    <a href="#" target="_blank" rel="noreferrer"
                       class="text-gray-300 hover:underline">Licensing</a>
                </li>
                <li class="mb-4">
        ...
        <div>
            ...
            <ul>
                ...
                <li class="mb-4">
                    <a href="#" target="_blank" rel="noreferrer"
                       class="text-gray-300 hover:underline">Android</a>
                </li>
            </ul>
        </div>
    </div>
