                        ...
                        <form action="AddJob" method="post">
                            <div class="mb-6">
                                ...
                                <input name="loc"
                                       ...
                                       id="loc" type="text" placeholder="Location" required pattern=".{,50}" title="Max 50 letters" />
                                ...
                                <input name="vac"
                                       class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker mb-2"
                                       id="vac" type="number" placeholder="Vacancy" required />
                                ...
                                <input name="ivl"
                                       class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker mb-2"
                                       id="ivl" type="text" placeholder="Interview Location" required pattern=".{,45}" title="Max 45 letters" />
                                ...
                                <input name="sal"
                                       class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker mb-2"
                                       id="salary" type="number" placeholder="in Nepali Rupees(NRS)" required pattern=".{,45}" title="Max 45 digits">
                            </div>
                            <div class="mb-3">
