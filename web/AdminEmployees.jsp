                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="job-category-listing mb-50">
                                ...
                                <div class="single-listing">
                                    <div class="select-Categories pb-50">
                                        ...
                                        <div class="small-section-tittle2">
                                            <h4 class="p-2 pl-3 pb-1 rounded bg-amber-400  text-white">
                                                <a>
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-8">
                            <div class="flex justify-center text-3xl strong font-bold m-1">
                                Employee List
                            </div>
                            <div class="leftmar m-1 flex flex-wrap">

                                <!-- Initialize Employee Object to display -->
                                <% List<Employee> E = (List<Employee>) request.getAttribute("EmployeeList");
                                    System.out.println(E);
                                    if (!E.isEmpty()) {
                                %>
                                <table class="m-3 w-full text-sm text-left text-gray-700 dark:text-gray-400 border-2">
                                    <thead
                                        class="text-xs text-gray-700 uppercase bg-gray-100 dark:text-gray-400">
                                        <tr>
                                    ...
                                    <div class="flex justify-center text-2xl strong m-5 ">
                                        No Employee
                                    </div>
                                    <% }%>
                                </table>
