...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="boot/css/owl.carousel.min.css">
        <link rel="stylesheet" href="boot/css/price_rangs.css">
        <link rel="stylesheet" href="boot/css/flaticon.css">
        <link rel="stylesheet" href="boot/css/slicknav.css">
        <link rel="stylesheet" href="boot/css/animate.min.css">
        <link rel="stylesheet" href="boot/css/magnific-popup.css">
        <link rel="stylesheet" href="boot/css/fontawesome-all.min.css">
        <link rel="stylesheet" href="boot/css/themify-icons.css">
                            ...
                            <div class="job-category-listing mb-50">
                                ...
                                <div class="single-listing">
                                    <div class="select-Categories pb-50">
                                        ...
                                        <div class="small-section-tittle2">
                                            <h4 class="p-2 pl-3 pb-1 rounded">
                                                <a href="Jobs" class="hover:text-cyan-400">
                                        ...
                                        <div class="small-section-tittle2">
                                            <h4 class="p-2 pb-1 pl-3 rounded">
                                                <a href="UserAppliedJobs" class="hover:text-cyan-400">
                                                    <i class="fas fa-list"></i>
                                                    Applied Jobs
                                                </a>
                                            </h4>
                                        ...
                                        <form action="UserUpdated" method="post">
                                            <div class="flex gap-5">
                                                <div class="flex flex-col mb-2 w-half">
                                                    <label class="block text-grey-darker text-sm font-bold text-slate-800 "
                                                           for="firstName">
                                                        First Name
                                                    </label>
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div>
                                                    <label for="gender"
                                                           class="text-grey-darker text-sm font-bold mb-2 text-slate-800 ">Gender:
                                                    </label>
                                                    <input name="gender" type="radio" class="ml-3 mb-2 text-slate-800 "
                                                           value="Male"> <span class="text-slate-800 "> Male </span>
                                                    <input name="gender" type="radio" class="ml-5 mb-2 text-slate-800 "
                                                           value="Female"> <span class="text-slate-800 "> Female </span>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select multiple name="keySkills" id="keySkills"
                                                            class="w-1/2 block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                            ...
                                            <div class="flex flex-row gap-5">
                                                <input
                                                    class="bg-cyan-400 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded mt-5"
                                                    type="submit" value="Update">
                                                <input
                                                    class=" text-cyan-400 hover:bg-cyan-400 hover:text-white border border-cyan-00 font-bold py-2 px-4 rounded mt-5"
    ...
    <footer class="bg-gray-800">
        <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
            <div>
                ...
                <ul>
                    ...
                    <li class="mb-4">
                        <a href="#" target="_blank" rel="noreferrer" class="text-gray-300 hover:underline">Brand
                            Center</a>
                    </li>
                    <li class="mb-4">
            ...
            <div>
                ...
                <ul>
                    ...
                    </li><a href="#" target="_blank" rel="noreferrer" class="text-gray-300 hover:underline">
                    </a>
        ...
        <div class="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
            <span class="text-sm text-gray-300 sm:text-center">© 2022 <a href="https://#.com">#™</a>. All
                Rights Reserved.
            </span>
    ...
    <script src="./boot/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="./boot/js/popper.min.js"></script>
    <script src="./boot/js/bootstrap.min.js"></script>
    <!-- Jquery Mobile Menu -->
    <script src="./boot/js/jquery.slicknav.min.js"></script>

    <!-- Jquery Slick , Owl-Carousel Range -->
    <script src="./boot/js/owl.carousel.min.js"></script>
    <script src="./boot/js/slick.min.js"></script>
    <script src="./boot/js/price_rangs.js"></script>
    <!-- One Page, Animated-HeadLin -->
    <script src="./boot/js/wow.min.js"></script>
    <script src="./boot/js/animated.headline.js"></script>
    <script src="./boot/js/jquery.magnific-popup.js"></script>

    <!-- Scrollup, nice-select, sticky -->
    <script src="./boot/js/jquery.scrollUp.min.js"></script>
    <script src="./boot/js/jquery.nice-select.min.js"></script>
    <script src="./boot/js/jquery.sticky.js"></script>

    <!-- contact js -->
    <script src="./boot/js/contact.js"></script>
    <script src="./boot/js/jquery.form.js"></script>
    <script src="./boot/js/jquery.validate.min.js"></script>
    <script src="./boot/js/mail-script.js"></script>
    <script src="./boot/js/jquery.ajaxchimp.min.js"></script>
