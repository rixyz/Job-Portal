                    ...
                    <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="hidden sm:block sm:ml-6">
                            <div class="flex space-x-4">
                                <a href="#"
                                   class="text-slate-800 hover:text-amber-400 px-3 py-2 rounded-md text-sm font-medium">
                                    Home</a>
                                <a href="#"
                                   class="text-slate-800 hover:text-amber-400 px-3 py-2 rounded-md text-sm font-medium">
                                    About</a>
                    ...
                    <div class="row">
                                ...
                                <div class="single-listing">
                                    <div class="select-Categories pb-50">
                                        <div class="small-section-tittle2 ">
                                            <h4 class="p-2 pb-1 pl-3 rounded bg-amber-400  text-white">
                                                <a>
                                        ...
                                        <div class="small-section-tittle2">
                                            <h4 class="p-2 pl-3 pb-1 rounded">
                                                <a href="ListCompanies" class="hover:text-amber-400">
                                        ...
                                        <div class="small-section-tittle2">
                                            <h4 class="p-2 pl-3 pb-1 rounded">
                                                <a href="ListJobs" class="hover:text-amber-400">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-8">
                            ...
                            <section class="featured-job-area">
                                <div class="container">
                                    <div
                                        class="bg-gray-100 rounded grid grid-cols-3 grid-flow-row gap-4 p-2 place-content-center">
                                        <div class="bg-white rounded-md m-1 p-1 grid place-items-center text-lg">
                                            <span>
                                                New User
                                            </span>
                                            7
                                        ...
                                        <div class="bg-white rounded-md m-1 p-1 grid place-items-center text-lg col-span-2">
                                            <canvas id="oneChart" style="width:100%;max-width:600px"></canvas>
                                            <span>
                                                User Stats
                                            </span>
                                        </div>
                                        <div class="bg-white rounded-md m-1 grid place-items-center text-lg">
                                            <span>
                                                &nbsp;
                                            </span>

                                        </div>
                                        <div class="bg-white rounded-md m-1 p-1 grid place-items-center text-lg col-span-3">
                                            <canvas id="twoChart" style="width:100%;max-width:600px"></canvas>
                                            <span>
                                                People Interacted from
                                            </span>
                                        </div>
