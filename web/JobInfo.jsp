                    ...
                    <div class="row justify-content-between">
                            ...
                            <div class="single-job-items mb-50">
                                <div class="job-items">
                                    <div class="company-img company-img-details">
                                        <a href="#"><img src="boot/img/icon/job-list1.png" alt=""></a>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="post-details3  mb-50">
                                ...
                                <ul>
                                    <li>Location : <span><%=j.getLocation()%></span></li>
                                    <li>Vacancy Spot : <span><%=j.getVacancy()%></span></li>
                                    <li>Interview Location : <span><%=j.getIplace()%></span></li>
                                    <li>Apply within : <span><%=j.getDeadline()%></span></li>
                                    <li>Salary : <span>Rs <%=j.getSalary()%> monthly</span></li>
                                </ul>
                            ...
                            <div class="post-details4  mb-50">
                                ...
                                <span><%=c.getCname()%></span>
                                <p>It is a long established fact that a reader will be distracted by the readable content of
                                    a page when looking at its layout.</p>
                                <ul>
                                    <li>Name: <span><%=c.getCname()%></span></li>
                                    <li>Email: <span><%=c.getCemail()%></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
