        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-tittle white-text text-center">
                        <span class="text-5xl text-cyan-400">Job Posting Website</span>
                        <h2> How it works</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="border-2 border-sky-500 bg-white px-10 py-20 text-center mb-30">
